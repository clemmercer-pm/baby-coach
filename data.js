 ...
 * Content is NHS-informed (plus NCT / Tommy's / RoSPA for checklists). Sources are
 * logged in ../../project/artefacts/content-draft.md. General information, not a
 * substitute for a midwife, health visitor or GP; the app says so on every screen.
 */
...
var W = {
  ...
  preeclampsia:"Pre-eclampsia: call your maternity unit (or 111) if you get a severe headache, vision changes, sudden swelling of face, hands or feet, or pain just below your ribs."
};
...
const TIMELINE = [
  // ---------------- Pregnancy ----------------
  {
    ...
    milestone: "Pre-eclampsia warning signs",
    summary: "Third trimester proper. Nothing urgent yet, so start turning your attention to the birth and learn a couple of warning signs.",
    do: ["Get to know your baby's usual pattern of movements, as you'll rely on it in the coming weeks."],
    ...
    focus: {
      ...
      list: [
        ...
        "Vision problems, like blurring or flashing lights.",
        "Pain just below the ribs.",
        "Sudden swelling of the face, hands or feet.",
        "Vomiting later in pregnancy.",
        "These need same-day checking, so don't wait for your next appointment."
      ]
    },
  ...
  },
  {
    ...
    focus: {
      ...
      intro: "A birth plan is your preferences, not a contract, and you can change your mind at any time. Think through:",
      list: [
        "Where to give birth: home, a midwife-led unit, or a hospital labour ward.",
        "Pain relief, from breathing and TENS, to gas and air, to an epidural. Know the pros and cons of each.",
        "Positions and environment: what keeps you calm, like moving around, water, lighting, music.",
        "Assisted birth: your wishes if forceps or ventouse (vacuum) become needed.",
        "Your birth partner, and what role you want them to play.",
  ...
  },
  {
    ...
    milestone: "Packing your hospital bag",
    ...
    focus: {
      ...
      list: [
        ...
        "For after: maternity or super sanitary pads (not tampons), 5 or 6 pairs of old or paper knickers, 2 to 3 supportive or nursing bras, going-home clothes (still bump-sized).",
        "Washbag: toothbrush, toiletries, flannel, deodorant.",
        "For baby: vests, sleepsuits and a hat (2 to 3 each), nappies, cotton wool, a going-home outfit.",
  ...
  },
  {
    ...
    watch: [W.movements, W.preeclampsia],
    note: ["You'll usually have a midwife appointment around now, so bring your questions."],
    links: [L.packBag, L.movements]
  },
  {
    phase: "pregnancy", week: 35, label: "35 weeks pregnant",
    milestone: "Choosing the car seat",
    ...
    focus: {
      ...
      list: [
        ...
        "Never in a front seat with an active airbag, which is dangerous and illegal.",
        ...
        "Get the fit checked, as many retailers and safety schemes will check it for free."
      ]
    },
  ...
  },
  {
    ...
    summary: "Any day now, though most first babies arrive after the due date.",
  ...
  },
  {
    ...
    milestone: "If your baby's overdue",
    summary: "This week's focus: what happens if baby's not here yet (completely normal).",
    do: ["Talk to your midwife about next steps, as most first babies come after the due date."],
    watch: [W.movements, W.preeclampsia],
    ...
    focus: {
      ...
      list: [
        "A membrane sweep, usually from 39 to 41 weeks: a finger swept around the cervix to try to start labour. It can be uncomfortable and cause period-like pains or a 'show'.",
        ...
        "Keep tracking movements while you wait, and call immediately if they change."
      ]
    },
  ...
  // ---------------- Newborn / fourth trimester (WEEK OF LIFE: week 1 = days 0-6) ----------------
  {
    ...
    focus: {
      ...
      list: [
        ...
        "In a clear, separate cot or Moses basket, with no pillows, bumpers, or loose bedding.",
        "'Feet to foot': baby's feet at the end of the cot so they can't wriggle under covers.",
        "In your room for the first 6 months.",
        "Room at 16 to 20°C, and don't let baby overheat.",
  ...
  },
  {
    ...
    focus: {
      ...
      list: [
        ...
        "Breastfeeding shouldn't hurt. Pain usually means a shallow latch, so ask your midwife or a breastfeeding supporter to check positioning early.",
        "If breastfeeding: a daily 10mcg vitamin D supplement for you, and 8.5 to 10mcg for baby if they're exclusively breastfed.",
        "If bottle-feeding, make up feeds safely and pace them, holding baby close and fairly upright.",
  ...
  },
  {
    ...
    focus: {
      title: "Crying, and how to cope",
      intro: "Crying peaks from around 2 weeks to 3 or 4 months. It's normal and not a sign you're doing anything wrong. To soothe:",
      list: [
        "Hold baby close, skin-to-skin or in a sling, and let them hear your heartbeat.",
        ...
        "About 1 in 5 babies has colic (long bouts of hard-to-soothe crying), and it passes.",
        ...
        "Cry-sis helpline: 0800 448 0737 (9am to 10pm, every day)."
      ]
    },
  ...
  },
  {
    ...
    milestone: "Looking after your mental health",
    ...
    watch: ["Same newborn red flags: fever, poor feeding, fewer wet nappies, unusual drowsiness, so seek advice."],
    note: ["Anything you want to raise at the 6 to 8 week review."],
    focus: {
      ...
      list: [
        ...
        "If low mood lasts longer, deepens, or you can't cope, it may be postnatal depression, which is common, treatable, and nothing to be ashamed of.",
        ...
        "Rarely, a new mother can develop postpartum psychosis (sudden confusion, hallucinations, or feeling manic), which is a medical emergency: call 999 or go to A&E.",
  ...
  },
  {
    ...
    summary: "The 6 to 8 week reviews are coming, so get them booked.",
    do: ["Look out for the health visitor's letter about the 6 to 8 week review; book baby's first vaccinations if not already."],
  ...
  },
  {
    ...
    focus: {
      ...
      list: [
        "The 6 to 8 week review: a developmental check for baby and a chance to talk about how you're both doing.",
